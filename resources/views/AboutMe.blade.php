...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16">
          <i class="fa fa-asterisk fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education</h2>
       ...
       <div class="w3-container">
        ...
        <hr>
      <div class="w3-container">
          <h5 class="w3-opacity"><b>Accomplishments</b></h5>
          <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>2018 - 2019</h6>
          <p>3rd Place SADA Project for Deaf and dumb In EGYPT & UAE</p>
        </div>
      </hr>
      <hr>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Fayum University</b></h5>
          <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>2015 - 2019</h6>
          <div>Bachelor of Science : Computer Science </div>
          <div>Grade : very good</div><br>
        </div>
      </div>
</hr>
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16">
          <i class="fa fa-bars fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>VOLUNTEERING</h2>
    <h5 class="w3-opacity"><b>Fayum University</b></h5>
          <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>2018 - 2019</h6>
          <div>Former Media Committee at ICBSEA</div>
            <hr>
          <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>2017 - 2018</h6>
          <div>Leadership Preparation Camp</div></hr>
          <hr>
         <h6 class="w3-text-teal">
